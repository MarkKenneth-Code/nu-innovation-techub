...
export default function Exhibits() {
  return (
    <section className="section-content pt-5" id="exhibits">
      <div className="container pt-5">
        <div className="container d-flex flex-column-reverse  align-items-center mb-5">
          ...
          <h5 className="fw-lighter">Tech Expo, Trade Fairs, &amp; Conferences</h5>
        </div>
        <Carousel fade>
...
const exhibits = [
  {
    exhibitImage: 'https://mms.businesswire.com/media/20171102006481/en/622309/5/GOPR7988v3.jpg',
